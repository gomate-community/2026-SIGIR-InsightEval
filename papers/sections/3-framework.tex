...
As illustrated in Figure~\ref{fig:architecture},The InsightEval framework implements a four-stage evaluation pipeline. Each stage is modular and can be independently configured or extended.
